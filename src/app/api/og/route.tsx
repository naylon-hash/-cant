  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ whiteSpace: "pre-wrap", fontSize: 40, lineHeight: 1.3, color: "#e5e7eb" }}>
          {`$CANT> ${cant}`}
        </div>
        <div style={{ height: 20 }} />
        <div style={{ whiteSpace: "pre-wrap", fontSize: 34, lineHeight: 1.3 }}>
          {`$CANT_AI> ${can}`}
        </div>
      </div>
    ),
    { width: 1200, height: 630 } // size goes in the ImageResponse options here
  );
}
